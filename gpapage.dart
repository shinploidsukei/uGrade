...
class GPAState extends State<GPA>{
  ...
  Widget build(BuildContext context){
    return new Scaffold(
      appBar: new AppBar(title: Image.asset('assets/images/uGradename.png', fit: BoxFit.cover), elevation: 0, backgroundColor: Colors.white),
          ...
          children: <Widget>[
            new TextField(
              ...
              decoration: new InputDecoration(
                  ...
                  hintText: "Please type numbers of your subjects ",
